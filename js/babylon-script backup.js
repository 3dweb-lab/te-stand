...
var delayCreateScene = function () {
    ...
    // LOAD 3D MODEL
    BABYLON.SceneLoader.ImportMesh("", "assets/models/", "TE_for_glb_04.glb", scene, async function(newMeshes){
    ...
    // const fileName = "TE_for_glb_04.glb";

    // function loadAssetContainerAsync(scene, data, rootUrl, onProgress, fileName) {
