const { TransformNode } = require("babylonjs");
...
var createScene=function(){var scene=new BABYLON.Scene(engine);
    ...
    var sphere1=BABYLON.Mesh.CreateSphere("Sphere1",10,9,scene);
    var sphere2=BABYLON.Mesh.CreateSphere("Sphere2",2,9,scene);
    var sphere3=BABYLON.Mesh.CreateSphere("Sphere3",10,9,scene);
    var sphere4=BABYLON.Mesh.CreateSphere("Sphere4",10,.5,scene);
    var sphere5=BABYLON.Mesh.CreateSphere("Sphere5",10,9,scene);
    var sphere6=BABYLON.Mesh.CreateSphere("Sphere6",10,9,scene);
    var sphere7=BABYLON.Mesh.CreateSphere("Sphere7",10,9,scene);
    ...
    button1.onPointerUpObservable.add(function(){circle.scaleX+=.1});
    ...
    button2.onPointerUpObservable.add(function(){circle.scaleX-=.1});
    panel.addControl(button2);
    
    var createLabel=function(mesh){var label=new BABYLON.GUI.Rectangle("label for "+mesh.name);
    ...
    var addRadio=function(text,parent){var button=new BABYLON.GUI.RadioButton;
    button.width="40px";
    button.height="40px";
    button.color="white";
    button.background="green";
    button.onIsCheckedChangedObservable.add(function(state){if(state){textblock.text="You selected "+text}});
    ...
    header.children[1].onPointerDownObservable.add(function(){button.isChecked=!button.isChecked});
    ...
    scene.registerBeforeRender(function(){panel.rotation+=.01});
    ...
    picker.height="150px";
    picker.width="150px";
    picker.onValueChangedObservable.add(function(value){sphereMaterial.diffuseColor=value});
    panel3.addControl(picker);
    
    return scene
};

var demo={constructor:createScene,onload:function(){}};